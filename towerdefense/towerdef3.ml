...
let display renderer foes chuncks towers =
  ...
  List.iter (fill_rect renderer cyan) towers;
...
let () =
  ...
  let dur1 = 6000 in
  let dur2 = 6000 + 4000 in
  let dur3 = 6000 + 2000 in
  ...
  let rec main_loop towers =
    ...
    display renderer foes chuncks towers;
    Timer.delay 20;
    main_loop towers
  in
  main_loop towers
